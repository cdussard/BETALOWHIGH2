...
function process(box)
    ...
    for i = 1, #sequence_yoked_nf_blocks do --nb_of_blocks do
        ...
        if (sequence_yoked_nf_blocks[i] == OVTK_StimulationId_Number_13 or sequence_yoked_nf_blocks[i] == OVTK_StimulationId_Number_14) then
            if sequence_yoked_nf_blocks[i] == OVTK_StimulationId_Number_13 then
                ...
                nb_trials_per_block = n_trials_nf
            elseif sequence_yoked_nf_blocks[i] == OVTK_StimulationId_Number_14 then
                box:send_stimulation(1, OVTK_StimulationId_Label_0A, t, 0) -- instruction obs
                nb_trials_per_block = n_trials_obs
            end
...
--        end
        elseif sequence_yoked_nf_blocks[i] == OVTK_StimulationId_Number_15 then--GO NO GO
       ...
       box:send_stimulation(1, OVTK_StimulationId_Label_1E, t, 0) --FIN DU GONOGO CLOSE WINDOW
